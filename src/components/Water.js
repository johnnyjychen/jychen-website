...
const Water = () => {
    return (
        <div className="project-container">
            <h1 className="page-title">Aging Water Infrastructures in Michigan</h1>

            <div className="project-section">
                <h2>Project Information</h2>
                <ul>
                    <li><span className='highlight-text'>Overview</span>: In this project, our group spent three months studying Michigan municipalities' challenges in collecting, analyzing, and sharing data.
                    ...
                    <li><span className='highlight-text'>Skills</span>: Qualitative Research, Thematic Analysis (Miro), Google Products</li>
            ...
            <div className="project-section">
                ...
                <p><span className='highlight-text'>Question 1</span>: What are the methods different municipalities are using to assess water infrastructure quality, including maintenance and replacement needs? Where is this succeeding or failing?</p>
                <p><span className='highlight-text'>Question 2</span>: In the process of collecting data on water infrastructure, how can the measuring and sharing of information between different municipalities be enhanced? If so, what is it?</p>
            </div>

            <div className="project-section">
                <h2>Process</h2>
                <p><span className='highlight-text'>Step 1</span>: Conducted research on Google Scholar and water service websites, identified ten sources, and summarized findings in a Google Sheet to pinpoint key issues and overlapping themes.</p>
                <p><span className='highlight-text'>Step 2</span>: Reviewed SME video interviews individually, analyzed relevant ideas on aging water infrastructure, and practiced interview techniques by asking questions and taking notes.</p>
                <p><span className='highlight-text'>Step 3</span>: Conducted SME Zoom interviews: Johnny interviewed Molly Maciejewski, Dawn interviewed Noah Urban, and the rest of the group interviewed Evan Pratt. Explored relevant topics and newly discovered points, including water infrastructure consolidation.</p>
                <p><span className='highlight-text'>Step 4</span>: Conducted interviews with professional stakeholders from the City of Ann Arbor and EGLE using a prepared protocol. All team members attended a contextual interview with a City of Ann Arbor water plant employee, while Dawn and Aishah interviewed EGLE staff.</p>
                <p><span className='highlight-text'>Step 5</span>: Organized collected data using an affinity wall on Miro by categorizing ideas, summarizing each category, and iteratively refining the categorization process with color-coded sticky notes to identify common themes and important insights.</p>
                <img src={affinity} alt="The affinity wall" />
            </div>

            <div className="project-section">
                <h2>Findings</h2>
                <p><span className='highlight-text'>Finding 1</span>: Michigan collects robust water infrastructure data, including system status, quality testing, and equipment records, but lacks comprehensive analysis and faces gaps in data such as locations and statuses of all infrastructure. Enhanced analysis is needed to maximize utility from the data.</p>
                <p><span className='highlight-text'>Finding 2</span>: Standardization of water infrastructure data has potential benefits, such as informing systematic maintenance, but the contextual interview highlighted the need for flexibility due to project-specific requirements. A balance between standardization and customization is crucial.</p>
                <p><span className='highlight-text'>Finding 3</span>: Infrastructure maintenance and repair decisions are based on priority, using failure indicators like main breaks or water quality issues. Cost analysis determines whether to repair or replace infrastructure based on financial considerations.</p>
                <p><span className='highlight-text'>Finding 4</span>: Communication across municipalities is supported by databases from the Water Research Foundation and American Waterworks Foundation, which provide shared research resources. Municipalities can also consult individual engineers and consultants for expertise.</p>
                <p><span className='highlight-text'>Finding 5</span>: EGLE advocates for consolidating water infrastructure to support financially struggling municipalities, but risks include higher costs and the potential for larger-scale impacts from single failures. Consolidation requires careful evaluation of financial benefits versus risks.</p>
            </div>
